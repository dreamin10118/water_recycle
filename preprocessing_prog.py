...
# 資料前處理
elct_df = pd.read_csv('sensors.electricmetersensordatamodel_all.sample.csv')
flow_df = pd.read_csv('sensors.flowmetersensordatamodel_all.sample.csv')
orp_df = pd.read_csv('sensors.orpsensordatamodel_all.sample.csv')
ph_df = pd.read_csv('sensors.phsensordatamodel_all.sample.csv')
